...
import { AppName } from '../../consts/const'
import makeCustomTheme from './theme';
...
const GenericTemplate: React.FC<GenericTemplateProps> = ({
  ...
  const handleDarkModeOn = () => {
    localStorage.setItem(AppName + "DarkMode", "on");
    setDarkMode(true);
  };
  const handleDarkModeOff = () => {
    localStorage.setItem(AppName + "DarkMode", "off");
    setDarkMode(false);
  };
  
  const theme = makeCustomTheme(darkMode);
